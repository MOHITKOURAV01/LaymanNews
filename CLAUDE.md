...
**Antigravity / Claude Opus** (Google DeepMind) — Used as the primary AI coding assistant for architecture design, API integrations, SwiftUI view composition, debugging, and iterative development.
